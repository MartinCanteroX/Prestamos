...
<div class="content-wrapper">
  <!-- Content Header (Page header / Titulo de la pagina ) -->
...
<!-- <script type="text/javascript" src="<?php echo BASE_URL_JS ?>clases/categorias.class.js"></script> -->
<!-- <script type="text/javascript" src="<?php echo BASE_URL_JS ?>clases/cuenta.class.js"></script> -->
...
<!-- <script type="text/javascript" src="<?php echo BASE_URL_JS ?>controllers/main.controller.js"></script> -->